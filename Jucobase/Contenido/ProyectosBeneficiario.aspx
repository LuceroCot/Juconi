<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Contenido/Content.Master" CodeBehind="ProyectosBeneficiario.aspx.vb" Inherits="Jucobase.ProyectosBeneficiario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <main id="main" class="main">
        <div class="pagetitle">
          <h1>Asignar beneficiario a proyecto</h1>
          <nav>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="Default.aspx">Inicio</a></li>
              <li class="breadcrumb-item active">Proyectos - Beneficiario</li>
            </ol>
          </nav>
        </div><!-- End Page Title -->
                  ...
                  <div class="card info-card customers-card">
                    <div class="card-body mt-3">
                        <h5 class="card-title fw-bold ps-4">&nbsp
                         Asignar beneficiario a proyecto</h5>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="row align-items-center mt-3 mx-3">
                                ...
                                <div class="col-md-3">
                                  <label for="inputBeneficiario" class="col-form-label fw-bold">Beneficiario</label>
                                  <div class="mb-3">
                                    <asp:TextBox ID="inputBeneficiario" runat="server" CssClass="form-control"></asp:TextBox>
                                  </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="row align-items-center mt-3 mx-3">
                                <div class="col-md-3">
                                  <label for="inputFamiliaNru" class="col-form-label fw-bold">NRU</label>
                                  <div class="mb-3">
                                    <asp:TextBox ID="inputFamiliaNru" runat="server" CssClass="form-control"></asp:TextBox>
                                  </div>
                                </div>
