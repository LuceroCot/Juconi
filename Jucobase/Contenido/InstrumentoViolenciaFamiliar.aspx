<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Contenido/Content.Master" CodeBehind="InstrumentoViolenciaFamiliar.aspx.vb" Inherits="Jucobase.InstrumentoViolenciaFamiliar" %>
        ...
        <div class="pagetitle">
          ...
          <nav>
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Instrumento de violencia familiar</li>
            </ol>
          </nav>
        </div><!-- End Page Title -->
                                            ...
                                            <tbody class="small">
                                                <tr>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td><asp:TextBox ID="TextBox1" CssClass="form-control" MaxLength="2" Width="45px" runat="server">0</asp:TextBox></td>
                                                    <td><asp:TextBox ID="TextBox2" CssClass="form-control" MaxLength="2" Width="45px" runat="server">0</asp:TextBox></td>
                                                    <td><asp:TextBox ID="TextBox3" CssClass="form-control" MaxLength="2" Width="45px" runat="server">0</asp:TextBox></td>
                                                    <td><asp:TextBox ID="TextBox4" CssClass="form-control" MaxLength="2" Width="45px" runat="server">0</asp:TextBox></td>
                                                    <td><asp:TextBox ID="TextBox5" CssClass="form-control" MaxLength="2" Width="45px" runat="server">0</asp:TextBox></td>
                                                    <td><asp:TextBox ID="TextBox6" CssClass="form-control" MaxLength="2" Width="45px" runat="server">0</asp:TextBox></td>
                                                    <td><asp:TextBox ID="TextBox7" CssClass="form-control" MaxLength="2" Width="45px" runat="server">0</asp:TextBox></td>
                                                    <td><asp:TextBox ID="TextBox8" CssClass="form-control" MaxLength="2" Width="45px" runat="server">0</asp:TextBox></td>
